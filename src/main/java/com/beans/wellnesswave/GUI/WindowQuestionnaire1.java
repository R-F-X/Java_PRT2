...
public class WindowQuestionnaire1 extends javax.swing.JFrame {
    public WindowQuestionnaire1() {
        initComponents();
    }

    protected String userID; 
    public WindowQuestionnaire1(String inUserID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        sidePane.setBackground(new java.awt.Color(96, 119, 68));
        ...
        btnSubmit.setFont(new java.awt.Font("Cambria", 0, 20)); // NOI18N
        btnSubmit.setForeground(new java.awt.Color(193, 255, 114));
        ...
        btnSubmit1.setFont(new java.awt.Font("Cambria", 0, 20)); // NOI18N
        btnSubmit1.setForeground(new java.awt.Color(193, 255, 114));
        ...
        jPanel3.setBackground(new java.awt.Color(71, 98, 38));
        ...
        jButton4.setText("Start Questionnaire");
        ...
        container.setBackground(new java.awt.Color(71, 98, 38));
        ...
        jButton5.setForeground(new java.awt.Color(193, 255, 114));
        jButton5.setText("Next section");
        ...
        jButton6.setForeground(new java.awt.Color(193, 255, 114));
        jButton6.setText("Previous Section");
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowQuestionnaire1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowQuestionnaire1().setVisible(true);
            }
        });
    }

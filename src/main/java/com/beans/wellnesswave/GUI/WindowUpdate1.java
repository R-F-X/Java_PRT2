...
public class WindowUpdate1 extends javax.swing.JFrame {
    public WindowUpdate1() {
        initComponents();
    }
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        // mine
        // DBUpdate.updateRecord("Disorder", "disorder_ID", columnSelect, dID ,change);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowUpdate1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowUpdate1().setVisible(true);
            }
        });
    }

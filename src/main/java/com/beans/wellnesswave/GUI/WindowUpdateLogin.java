...
public class WindowUpdateLogin extends javax.swing.JFrame {
    public WindowUpdateLogin() {
        initComponents();
    }
...
//        System.out.println("THIS IS THE COMBOBOX VALUE:" + columnSelect);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowUpdateLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

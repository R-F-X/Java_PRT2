...
public class WindowUpdateJEntry extends javax.swing.JFrame {
    public WindowUpdateJEntry() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Journal Entry");

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel2.setText("journal_ID: ");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "user_ID", "journal_entry" }));
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        // success
            ...
            // ? 
//            DBUpdate.updateRecord("journal", columnSelect, "user_ID", dID, change);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowUpdateJEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowUpdateJEntry().setVisible(true);
            }
        });
    }

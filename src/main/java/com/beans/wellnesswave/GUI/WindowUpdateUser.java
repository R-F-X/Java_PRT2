...
public class WindowUpdateUser extends javax.swing.JFrame {
    public WindowUpdateUser() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "user_first_name", "user_last_name", "user_email", "account_type" }));
...
//            DBUpdate.updateDisorder("doctor", columnSelect, dID , change);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowUpdateUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
